...
exports.createPolicy = async (req, res) => {
  try {
    ...
    await prisma.auditLog.create({
      data: {
        actorId: req.user.id,
        action: 'CREATE_INCENTIVE_POLICY',
        targetTable: 'incentive_policy',
        targetId: policy.id,
        details: { iprType, policyName, baseIncentiveAmount, basePoints }
      }
    });
...
exports.updatePolicy = async (req, res) => {
  try {
    ...
    await prisma.auditLog.create({
      data: {
        actorId: req.user.id,
        action: 'UPDATE_INCENTIVE_POLICY',
        targetTable: 'incentive_policy',
        targetId: policy.id,
...
exports.deletePolicy = async (req, res) => {
  try {
    ...
    await prisma.auditLog.create({
      data: {
        actorId: req.user.id,
        action: 'DELETE_INCENTIVE_POLICY',
        targetTable: 'incentive_policy',
        targetId: id,
        details: { deletedPolicy: existingPolicy }
      }
    });
