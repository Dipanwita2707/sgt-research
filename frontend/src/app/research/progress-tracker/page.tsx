  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Research Progress Tracker</h1>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4 mb-8">
          ...
          {Object.entries(stats.byStatus).map(([status, count]) => (
            <div key={status} className="bg-white rounded-lg shadow p-4">
              <div className="text-sm text-gray-500">{statusLabels[status as ResearchTrackerStatus]}</div>
      ...
      {loading ? (
        ...
        <div className="bg-white rounded-lg shadow p-12 text-center">
          ...
          <h3 className="text-lg font-medium text-gray-900 mb-2">No research tracked yet</h3>
