...
export default function MyWorkDashboard() {
  ...
  const fetchAllData = async () => {
    try {
      ...
      console.log('My Contributions Response:', myContribRes);
      console.log('Contributed Response:', contributedRes);
      ...
      console.log('Processed myContributions:', myContributions);
      console.log('Processed contributed:', contributed);
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Header */}
      <div className="bg-sgt-gradient text-white shadow-lg">
      ...
      <div className="max-w-7xl mx-auto px-4 -mt-4">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4 mb-6">
          <div className="bg-white p-5 rounded-xl shadow-sm border border-gray-200">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900 mt-1">{combinedStats.total}</p>
              </div>
          ...
          <div className="bg-white p-5 rounded-xl shadow-sm border border-gray-200">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-yellow-600 mt-1">{combinedStats.pending}</p>
              </div>
          ...
          <div className="bg-white p-5 rounded-xl shadow-sm border border-gray-200">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-green-600 mt-1">{combinedStats.approved}</p>
              </div>
          ...
          <div className="bg-white p-5 rounded-xl shadow-sm border border-gray-200">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-gray-500 text-sm font-medium">Total Incentives</p>
                <p className="text-2xl font-bold text-green-600 mt-1">₹{combinedStats.totalIncentives.toLocaleString()}</p>
              </div>
              <div className="w-12 h-12 bg-green-100 rounded-lg flex items-center justify-center">
          ...
          <div className="bg-white p-5 rounded-xl shadow-sm border border-gray-200">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-purple-600 mt-1">{combinedStats.totalPoints}</p>
              </div>
            ...
            <div className="flex">
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className={`px-2 py-0.5 rounded-full text-xs font-bold ${
                    activeTab === 'ipr' ? 'bg-blue-100 text-blue-700' : 'bg-gray-100 text-gray-600'
                  }`}>
                    {iprStats.total}
                  </span>
                </div>
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className={`px-2 py-0.5 rounded-full text-xs font-bold ${
                    activeTab === 'research' ? 'bg-blue-100 text-blue-700' : 'bg-gray-100 text-gray-600'
                  }`}>
                    {researchStats.total}
                  </span>
                </div>
          ...
          <div className="p-6">
            {activeTab === 'ipr' && (
              <div>
                {/* Quick Create Cards */}
                <div className="mb-8">
                  <h3 className="text-lg font-semibold text-gray-900 mb-4">Create New IPR Application</h3>
                    ...
                    {IPR_TYPES.map((iprType) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <h4 className="font-semibold text-gray-900 mb-1">{iprType.label}</h4>
                          <p className="text-gray-600 text-xs">{iprType.description}</p>
                        </Link>
                      );
                    })}
                  </div>
                ...
                <div>
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="text-lg font-semibold text-gray-900">My IPR Applications</h3>
                    <Link href="/ipr/my-applications" className="text-blue-600 hover:text-blue-700 text-sm font-medium">
                      View All →
                    </Link>
                  </div>
