...
export default function UnifiedMentorApprovalsPage() {
  ...
  const renderIprCard = (app: IprApplication) => {
    ...
    return (
      <div key={app.id} className="bg-white rounded-xl border border-gray-200 hover:border-blue-300 hover:shadow-md transition-all duration-200 p-6">
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-sgt-gradient text-white shadow-lg">
        <div className="max-w-7xl mx-auto px-4 py-8">
          <Link href="/dashboard" className="inline-flex items-center text-white hover:text-sgt-100 mb-4 transition-colors">
            ...
            <div className="flex">
              <button
                ...
                className={`px-8 py-4 font-semibold transition-colors relative ${
                  mainTab === 'ipr' ? 'text-blue-600' : 'text-gray-600 hover:text-gray-900'
                }`}
              >
                ...
                {mainTab === 'ipr' && <div className="absolute bottom-0 left-0 right-0 h-0.5 bg-blue-600"></div>}
              </button>
              
              <button
                onClick={() => { setMainTab('research'); setSubTab('pending'); }}
                className={`px-8 py-4 font-semibold transition-colors relative ${
                  mainTab === 'research' ? 'text-blue-600' : 'text-gray-600 hover:text-gray-900'
                }`}
              >
                <div className="flex items-center gap-2">
                ...
                {mainTab === 'research' && <div className="absolute bottom-0 left-0 right-0 h-0.5 bg-blue-600"></div>}
              </button>
            </div>
          </div>
            ...
            <div className="flex px-4">
              <button
                ...
                className={`px-6 py-3 text-sm font-medium transition-colors ${
                  subTab === 'pending' ? 'text-blue-600 border-b-2 border-blue-600' : 'text-gray-600 hover:text-gray-900'
                }`}
              >
                Pending Approvals
              ...
              <button
                ...
                className={`px-6 py-3 text-sm font-medium transition-colors ${
                  subTab === 'history' ? 'text-blue-600 border-b-2 border-blue-600' : 'text-gray-600 hover:text-gray-900'
                }`}
              >
                Review History
              </button>
            ...
            {loading ? (
              ...
              iprPending.length === 0 ? (
                <div className="text-center py-12 bg-gray-50 rounded-xl border-2 border-dashed border-gray-300">
                  ...
                  <p className="text-gray-500">All caught up! You have no pending mentor approvals.</p>
                </div>
              ) : (
