...
export default function MentorCollaborativeEditor({
  ...
  const loadSuggestions = async () => {
    try {
      ...
      console.error('Failed to load mentor suggestions:', error);
    }
  };
  ...
  const handleCreateSuggestion = async () => {
    ...
    try {
      ...
      console.error('Failed to create mentor suggestion:', error);
  ...
  const handleRespondToSuggestion = async (suggestionId: string, action: 'accept' | 'reject', response?: string) => {
    ...
    try {
      ...
      alert('Failed to respond to suggestion. Please try again.');
    } finally {
      setLoading(false);
    }
  };
