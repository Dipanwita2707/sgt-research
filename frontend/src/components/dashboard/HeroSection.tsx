...
export default function HeroSection({ userName, userType, userImage }: HeroSectionProps) {
  ...
  return (
    <div className="relative overflow-hidden rounded-3xl mb-8 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-md transition-colors duration-200">
